...
bool MarkClientforDeletDataByAccountNumber(string AccountNumber, vector <sClient>& vClients)
{
	for (sClient& C : vClients)
	{
		if (C.AccountNumber == AccountNumber)
...
bool DeletDataByAccountNumber(string AccountNumber, vector<sClient>& vClient)
{
	sClient Client;
	char Answer = 'n';
	...
	if (FindClientByAccountNumber(AccountNumber, vClient, Client))
	{
		...
		cout << "Are You Sure To Delet Answer ? ";
		cin >> Answer;

		if (Answer == 'Y' || Answer == 'y')
		{
			MarkClientforDeletDataByAccountNumber(AccountNumber, vClient);
...
int main()
{
	...
	DeletDataByAccountNumber(AccountNumber, vClient);
