...
short GetActucalVavatoionDays(stDate Date1, stDate Date2)
{
	short DayCount = 0;
...
int main()
{
	...
	cout << "Vacatoion To : " << DayShortName(DayOfWeekOrder(Date2)) << " , "
		<< Date2.Day << "/" << Date2.Month << "/" << Date2.Year << "\n";

	cout << "Actucal Vavatoion Days is : " << GetActucalVavatoionDays(Date1, Date2);
